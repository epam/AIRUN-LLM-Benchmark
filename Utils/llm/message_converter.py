...
class OpenAIResponsesConverter(MessageConverter):
    ...
    def convert(
        ...
        for message in messages:
            ...
            for content in message.content:
                if isinstance(content, TextAIMessageContent):
                    content_items.append(ResponseInputTextParam(type="input_text", text=content.text))
                elif isinstance(content, ImageAIMessageContent):
                    ...
                    # Tool responses are separate items
                    api_messages.append(
            ...
            if content_items:
                ...
                api_messages.append(EasyInputMessageParam(role=role, content=content_items))
